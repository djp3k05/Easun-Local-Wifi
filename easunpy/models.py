...
class PVData:
    total_power: int
    charging_power: int
    charging_current: float # Changed to float for ASCII model
    temperature: int
    pv1_voltage: float
    pv1_current: float # Changed to float for ASCII model
    pv1_power: int
    pv2_voltage: float
    pv2_current: float # Changed to float for ASCII model
    pv2_power: int
    pv_generated_today: float # Changed to float for consistency
    pv_generated_total: float # Changed to float for consistency
...
class RegisterConfig:
    """Configuration for a single register for Modbus models."""
    address: int
...
class ModelConfig:
    ...
    name: str
    protocol: str = "modbus" # "modbus" or "ascii"
